...
colour_4=(213,200,80)    #light yellow
...
display_style=pygame.font.SysFont("arial",25,bold=True)
score_font=pygame.font.SysFont("comicsansms",45,bold=True)
	...
	def game_start():
	 	...
	 	while not game_over:
	 		...
	 		while game_close== True:
	 			...
	 			display_msg("You Lost! Wanna Play Again? Press C-Play Again or Q-Quit",colour_4)
